...
using CometX.NETCore.Repository;
using CometX.NETCore.Entities.Extensions;
using CometX.NETCore.Entities.TableEntity;
using CometX.NETCore.Repository.Extensions;
using CometX.NETCore.Attributes.Extensions.PropertyExtensions;
...
{
    public class CometXService : ICometXService
    {
        ...
        public CometXService(string key = "")
        {
        ...
        //TODO Ensure this is on the .Net Framework
        /// <summary>

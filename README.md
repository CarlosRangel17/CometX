...
| CometX.Service | ![image](https://user-images.githubusercontent.com/11052295/71768303-9ec9e080-2eda-11ea-81f2-4b7eecb43294.png) | The Service library is a CometX factory that implements upon <br/>the CometX project: `CometX.Repository`, `CometX.Attributes`,<br/>and `CometX.Entities`. This factory translates your LINQ into raw SQL queries to perform a variety of data accessing requirements. |

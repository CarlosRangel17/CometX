...
| CometX.Service | ![image](https://user-images.githubusercontent.com/11052295/71768303-9ec9e080-2eda-11ea-81f2-4b7eecb43294.png) | The Service library is a CometX factory that implements upon <br/>the CometX project: `CometX.Repository`, `CometX.Attributes`, and `CometX.Entities`. This factory translates<br/>your LINQ into raw SQL queries to perform a variety of<br/>data accessing requirements. |
